...
sealed interface ProfileDetailsEvent {
    ...
    data object RefreshProfilePicture: ProfileDetailsEvent
    data object RefreshProfileName: ProfileDetailsEvent
    data object RefreshProfileBio: ProfileDetailsEvent
