...
import com.hazrat.model.al_quran_model.local_quran_ar.findLocalQuranSurahNumberByAyahNumber
...
fun QuranScreen(
    ...
    Log.d("QuranScreen", "QuranScreen: ${quranState.arQuranData}")
    Log.d("QuranScreen", "QuranScreen En: ${quranState.quranEnData}")
