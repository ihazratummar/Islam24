...
print("Next steps:")
print("1. Copy 'quran_prepopulated.db' into your Android project under: app/src/main/assets/databases/")
print("2. Use Room's .createFromAsset(\"databases/quran_prepopulated.db\") in your Android app.")
